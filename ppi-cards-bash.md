...
# --------------PPI CARDS TEMPLATE ----------------
#
# This script works with it's partner python, PPI_CARDS.py, and a MATLAB script 
...
# Here we make sure the user has specified to run 'cards'.
case $ATASK in
...
sed -e 's@SUB_MOUNT_SUB@'$EXPERIMENT'@g' \
 ...
 -e 's@SUB_SUBJECT_SUB@'$SUBJ'@g' <$i> $OUTDIR/PPI_CARDS.m
 done
...
/usr/local/bin/matlab -display :$RANDINT < PPI_CARDS.m;

echo "Done running PPI_CARDS.m in matlab"
