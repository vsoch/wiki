...
# If you cannot compile bandpass.m and use the command below with run_bandpass, you might explore fsl 
...
# This is the compiled script bandpass.m, which uses the signal processing toolbox in matlab
