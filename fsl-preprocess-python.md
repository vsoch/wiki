# FSL Preprocess Python

Please note that this script was intended for an old cluster (Einstein).
...
template_f = file("PREPROCESS_TEMPLATE.sh")  #job template location (on head node)
...
funcfolder = "run004_04" #this is the name of the folder to convert
volume = "171" #This is the image number at the end of the functional run that must be deleted. MUST be in the format "012"
...
for subnum in subnums:
	...
	for run in runs:
		...
		tmp_job_fname = "_".join( ["PREPROCESS", subnum, runstr ] )
